...
public class JMSManageMO
{
   ...
   public JMSServerControl getJmsServerControl()
   {
      ...
      {
         jmsServerControl = (JMSServerControl) this.getManagementService().getResource(ResourceNames.JMS_SERVER);
      }
   ...
   public HornetQServerControl getHornetQServerControl()
   {
      ...
      {
         hornetQServerControl = (HornetQServerControl) this.getManagementService().getResource(ResourceNames.CORE_SERVER);
      }
