...
public interface HibernateMBean
{
    ...
    * The url to the har deployment, if MBean is operating in har deployment mode.
	 ...
	 * <br/>
	 * N.B. implies {@link #getCacheRegionFactoryClass()} == {@link org.hibernate.cache.jbc.JndiSharedCacheRegionFactory}
	 *
     ...
     * <br/>
     * N.B. implies {@link #getCacheRegionFactoryClass()} == {@link org.hibernate.cache.jbc.JndiMultiplexedCacheRegionFactory}
     *
     * @return The current setting
     */
