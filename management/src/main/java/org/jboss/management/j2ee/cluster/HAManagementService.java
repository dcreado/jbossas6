 ...
 * @version $Revision: 97783 $ <p>
 * @jmx:mbean extends="org.jboss.system.ServiceMBean"
 */
@JMX(name = "jboss:service=HAManagement", exposedInterface = HAManagementServiceMBean.class, registerDirectly = true)
...
//      return mHAManagementName;
           ...
           throws Exception
   {
      if (mPartition == null)
      {
         throw new IllegalStateException(HAPartition.class.getSimpleName() + " is null; must inject a " + HAPartition.class.getSimpleName());
      }
      mPartition.registerRPCHandler(SERVICE_NAME, this);
      log.debug("registered RPCHandler");
