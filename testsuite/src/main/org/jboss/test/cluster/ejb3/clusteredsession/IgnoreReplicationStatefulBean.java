...
@Clustered
@CacheConfig(name = "${jbosstest.cluster.sfsb.cache.config:sfsb-cache}", maxSize=1000, idleTimeoutSeconds=1, replicationIsPassivation=false)   // this will get evicted the second time eviction thread wakes up
