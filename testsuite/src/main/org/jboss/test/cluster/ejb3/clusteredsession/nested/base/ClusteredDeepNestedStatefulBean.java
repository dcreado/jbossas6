...
package org.jboss.test.cluster.ejb3.clusteredsession.nested.base;
...
@Clustered
@CacheConfig(name = "${jbosstest.cluster.sfsb.cache.config:sfsb-cache}", maxSize=10000, idleTimeoutSeconds=1, replicationIsPassivation=false) 
