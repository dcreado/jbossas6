   ...
   implements AppClientLauncher
{
   ...
   public static void main(String[] args)
   {
      try
      {
         String path = "vfs:///home/carlo/work/jboss-head/build/target/jboss-6.1.1-SNAPSHOT/server/cts/tmp/jsr88/ejb3_timer_basic_mdb.ear/ejb3_timer_basic_mdb_client.jar";
         mount(path);
      }
      catch(Exception e)
      {
